...
const registry: MilestoneDefinition[] = [
  ...
  { id: 'DAY_10_FERNS_UNLOCKED', requiredBloomDay: 10, label: 'Ferns', unlocks: 'ferns' },
  { id: 'DAY_11_BUSHES_UNLOCKED', requiredBloomDay: 11, label: 'Bushes', unlocks: 'bushes' },
  { id: 'DAY_12_TALL_GRASS_UNLOCKED', requiredBloomDay: 12, label: 'Tall Grass', unlocks: 'tall_grass' },
